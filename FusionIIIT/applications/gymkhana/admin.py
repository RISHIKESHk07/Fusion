...
from .models import (Club_budget,Club_info,Club_member,Club_report,Other_report,Session_info,Event_info,Fest,Registration_form,Form_available,Inventory,Budget,Budget_Comments,Event_Comments)
